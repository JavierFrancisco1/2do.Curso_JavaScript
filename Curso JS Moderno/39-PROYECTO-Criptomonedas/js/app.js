...
function mostrarCotizacionHTML(cotizacion) {
  ...
  ultimasHoras.innerHTML = `<small class='transparent'>Variación ultimas 24 horas:</small> <span class='p-short'>${CHANGEPCT24HOUR}%</span>`;

  const ultimaActualizacion = document.createElement("p");
  ultimaActualizacion.innerHTML = `<small class='transparent'>Ultima actualización:</small> <span class='p-short'>${LASTUPDATE}</span>`;
